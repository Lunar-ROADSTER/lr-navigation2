...
public:
    CmdVelToActuator() : Node("cmd_vel_to_actuator"), max_linear_speed(1.0), max_steering_angle(1.0) {
        subscription_ = this->create_subscription<geometry_msgs::msg::Twist>(
            "/cmd_vel", 10, std::bind(&CmdVelToActuator::cmd_vel_callback, this, std::placeholders::_1));
        publisher_ = this->create_publisher<cg_msgs::msg::ActuatorCommand>("/actuator_command", 10);
    }
...
private:
    void cmd_vel_callback(const geometry_msgs::msg::Twist::SharedPtr msg) {
        ...
        actuator_msg.wheel_velocity = std::clamp(actuator_msg.wheel_velocity, -100.0, 100.0);
