...
public:
    CmdVelToActuator() : Node("cmd_vel_to_actuator"), max_linear_speed(0.5), max_steering_angle(0.5), tool_height_(50.0) {
        ...
        actuator_pub_ = this->create_publisher<cg_msgs::msg::ActuatorCommand>("/autonomy_cmd", 10);
    }
...
private:
    void cmd_vel_callback(const geometry_msgs::msg::Twist::SharedPtr msg) {
        ...
        // actuator_msg.wheel_velocity = std::clamp(actuator_msg.wheel_velocity, -30.0, 30.0);
